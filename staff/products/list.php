...
" class="w-full h-[60px] flex items-center justify-between px-5 py-2">
        ...
        <div class="flex items-center gap-2 account__admin">
            <div class="account__admin--avatar">

                <img src="<?= $CONTENT_URL  ?>/images/users/<?= $_SESSION['user']['image'] ?>" alt=""
                    class="w-10 h-10 rounded-full" />
            </div>
            <div class="flex flex-col gap-1 account__admin--name">
                <p class="text-sm font-medium text-gray-500">
                    <?= $_SESSION['user']['name'] ?>
                </p>
                <a href="index.php?action=logout" class="flex items-center gap-1 text-xs text-gray-500 logout">
