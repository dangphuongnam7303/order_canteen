    ...
    ?>
        <section class="add__category w-full mt-5">
            ...
            <section class="mt-5 bg-[rgba(255, 255, 255, 0.4)] shadow-2xl rounded-xl p-5 lg:p-6 w-full">
                <form action="index.php?menu_id=<?= $menu_id ?>" class="form__add-category w-full" method="post"
                    enctype="multipart/form-data">
                    <div class="list__form-group w-full grid  grid-cols-1 gap-10">
                        <div class="form__group flex flex-col">
                            <label for="categorytid"
                                class="text-gray-500 text-xs sm:text-sm md:text-base lg:text-base">PRODUCT NAME</label>
                            <input placeholder="<?= $product_name ?>" disabled type="text" name="category_id"
                                id="category_id" class="form__input-add__prodcut shadow-2xl border border-gray-200 focus:outline-none
...
" />
                        ...
                        <div class="form__group flex flex-col ">
                            <label class="text-xs sm:text-sm md:text-base lg:text-base text-gray-500" for="name">Chọn
                                Sản phẩm thay thế</label>
                            ...
                            <select name="product_id1"
                                ...
                                <?php extract($key); ?>
                                <option value="<?= $product_id ?>" <?= $product_id == $check ? "selected" : "" ?>>
                                    <?= $product_name ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form__add-category--list-button w-full mt-7 flex gap-3 justify-center items-center">
                            <button type="submit" name="btn_update_product" style="text-shadow: 0.6px 0.6px 0 #fff; color: #61677c; box-shadow: 1.5px 1.5px
