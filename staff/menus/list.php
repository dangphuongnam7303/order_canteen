...
#bebebe, -35px -35px 70px #ffffff; " class="w-full  p-5 mt-5 bg-gray-100">
        <section class="list__accounts w-full">
            ...
            <form action="index.php?menu_id=<?= $menu_id ?>">
                <div class="list__accounts-table w-full mt-4 px-10">
...
1.5px 1.5px 2.5px #babecc, -2px -2px 5px #fff;"
                        ...
                        <a href="<?= $STAFF_URL ?>/menus/index.php">Thêm mới</a>
                    </button>
...
rounded-md text-sm hover:bg-gray-200 leading-4 whitespace-nowrap">
                        <a class="" href="<?= $STAFF_URL ?>/menus/index.php?btn_list_menu">Danh sách
                            thực đơn</a>
                    </button>
                </div>
            </form>
