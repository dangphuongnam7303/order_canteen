...
#bebebe, -35px -35px 70px #ffffff; " class="w-full  p-5 mt-5 bg-gray-100">
    <section class="list__accounts w-full">
      ...
      <form action="index.php?menu_id=<?= $menu_id ?>" method="post">
        <h3>Menu name: <?= $items[0]['menu_name'] ?></h3>
              ...
              ?>
                <tr class="border-t-2 border-dashed">
                  <td class="p-2 whitespace-nowrap">
                    <input type="checkbox" name="menu_id[]" value="<?= $menu_id ?>" class="checkbox" />
                  </td>
                  <td class="p-2 whitespace-nowrap">
                  ...
                  <td class="px-2 mt-2 whitespace-nowrap flex gap-3 items-center justify-center">
                    <a href="index.php?btn_edit_product&menu_id=<?= $menu_id ?>&product_id=<?= $product_id ?>" class="text-indigo-600 hover:text-indigo-900"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                      </svg>
                    </a>
                    <a href="index.php?btn_delete_product&menu_id=<?= $menu_id ?>&product_id=<?= $product_id ?>" class="text-indigo-600 hover:text-indigo-900"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
...
1.5px 1.5px 2.5px #babecc, -2px -2px 5px #fff;" type="submit" name="btn_add" class=" p-3  border rounded-md w-[120px] text-center   text-xs hover:bg-gray-200 leading-4 ">
            Add Product
          </button>
