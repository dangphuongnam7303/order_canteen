...
#bebebe, -35px -35px 70px #ffffff; " class="w-full  p-5 mt-5 bg-gray-100">
    ...
    <section class="add__category w-full mt-5">
      <section class="add__products-title flex  items-center gap-1">
        ...
        <h1 class="text-left lg:text-xl text-gray-500">ADD MENU</h1>
      </section>
        ...
        <form action="index.php" class="form__add-category w-full" method="post" enctype="multipart/form-data">
          <div class="list__form-group w-full grid  grid-cols-1 gap-10">
            <div class="form__group flex flex-col">
              <label for="menu_id" class="text-gray-500 text-xs sm:text-sm md:text-base lg:text-base">MENU ID</label>
              <input placeholder="Auto generate" disabled type="text" name="menu_id" id="category__id" class="form__input-add__prodcut shadow-2xl border border-gray-200 focus:outline-none
...
" />
            ...
            <div class="form__group flex flex-col ">
              ...
              <input type="text" class="form__input-add__prodcut shadow-2xl border border-gray-200 focus:outline-none text-xs sm:text-sm md:text-base lg:text-base bg-gray-100 mt-2 p-2 px-3  rounded-md text-gray-500 " name="menu_name" id="name" placeholder="Menu name" value="<?= $menu_name ?>" />
