    ...
    <main>
        ...
        <section class="add__category w-full mt-5">
            <section class="add__products-title flex  items-center gap-1">
                ...
                <h1 class="text-left lg:text-xl text-gray-500">EDIT MENU</h1>
            </section>

            <section class="mt-5 bg-[rgba(255, 255, 255, 0.4)] shadow-2xl rounded-xl p-5 lg:p-6 w-full">
                <form action="index.php?meni_id=<?= $menu_id ?>" class="form__add-category w-full" method="post" enctype="multipart/form-data">
                    <div class="list__form-group w-full grid  grid-cols-1 gap-10">
                        <div class="form__group flex flex-col">
                            <label for="categorytid" class="text-gray-500 text-xs sm:text-sm md:text-base lg:text-base">
                                <MENU:context></MENU:context> ID
                            </label>
                            <input placeholder="<?= $menu_id ?>" disabled type="text" name="category_id" id="category_id" class="form__input-add__prodcut shadow-2xl border border-gray-200 focus:outline-none
