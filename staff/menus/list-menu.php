        ...
        <section class="list__accounts w-full">
            ...
            <form action="index.php" method="post">
                <div class="list__accounts-table w-full   mt-4">
                    <table style="width:500px;" class="mx-auto text-center rounded-md shadow-md my-3">
                        <thead class="boder bg-gray-200 px-2 rounded-t-md">
                            <tr>
                                ...
                                <th class=" text-xs w-20  px-2 py-2 font-medium">
                                    Tên thực đơn
                                </th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-t-2 border-dashed">
                                ...
                                <td class="p-2 w-20 whitespace-nowrap">
                                    <p class="text-xs text-gray-900">
                                        <?= $menu_name ?>
                                    </p>
                                </td>
                                <td class="px-6 mt-2 whitespace-nowrap flex gap-3 items-center justify-center">
                                    <a href="<?= $STAFF_URL ?>/menus/index.php?btn_edit&menu_id=<?= $menu_id ?>"
                                    ...
                                    <a href="<?= $STAFF_URL ?>/menus/index.php?btn_delete&menu_id=<?= $menu_id ?>"
                                        class="text-indigo-600 hover:text-indigo-900"><svg
                                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                            <path stroke-linecap="round" stroke-linejoin="round"
...
1.5px 1.5px 2.5px #babecc, -2px -2px 5px #fff;" id="select"
                        class=" p-3  border  w-[120px] text-center rounded-md text-xs hover:bg-gray-200 leading-4 whitespace-nowrap">
                        Chọn tất cả
                    </label>
                    <label for="checkAll" style="text-shadow: 0.6px 0.6px 0 #fff; color: #61677c; box-shadow:
...
1.5px 1.5px 2.5px #babecc, -2px -2px 5px #fff;"
                        class="p-2 whitespace-nowrap  border rounded-md w-[120px] text-center   text-xs hover:bg-gray-200 leading-4 ">
                        <a href="<?= $STAFF_URL ?>/menus/index.php">Thêm mới
                        </a>
                    </button>
