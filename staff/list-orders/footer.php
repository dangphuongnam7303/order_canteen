            ...
            <div>
                <div class="container flex flex-col items-center justify-center px-5 py-4 mx-auto sm:flex-row">
                    <p class="text-sm text-center text-gray-500 sm:text-left">
                        © 2022 polyfood —
                        <a href="#" class="ml-1 text-gray-600" target="_blank"
...
<a style="box-shadow: 0 8px 32px 0 rgba(31, 38, 135, 0.37)" id="cart" href="<?= $SITE_URL ?>/cart/index.php?my-cart"
    class="fixed right-0 z-50 flex items-center justify-center w-16 h-16 mb-8 mr-8 text-gray-800 bg-orange-600 border border-gray-300 rounded-full shadow-sm sm:w-20 sm:h-20 animate-bounce bottom-8"
    target="_blank"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
        stroke="currentColor" class="text-white w-9 h-9">
