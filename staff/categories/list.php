                        ...
                        <tbody>
                            <?php foreach ($items as $item) : ?>
                                ...
                                <tr class="border-t-2 border-dashed">
                                    ...
                                    <td class="p-2 whitespace-nowrap">
                                        <img class="block mx-auto rounded-lg" src="<?= $CONTENT_URL ?>/images/categories/<?= $category_image ?>" width="60" height="60" alt="">
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <p class="text-xs text-gray-900">
                                            <?= $suggest ?>
                                    ...
                                    <td class="px-5  whitespace-nowrap">
                                        <div class="box__action flex gap-2">
                                            ...
                                            <a href="index.php?btn_delete&category_id=<?= $category_id ?>" class="text-indigo-600 hover:text-indigo-900"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
...
1.5px 1.5px 2.5px #babecc, -2px -2px 5px #fff;" id="select" class=" p-3  border  w-[120px] text-center rounded-md text-xs hover:bg-gray-200 leading-4 ">
                    ...
                    <label for="checkAll" style="text-shadow: 0.6px 0.6px 0 #fff; color: #61677c; box-shadow:
1.5px 1.5px 2.5px #babecc, -2px -2px 5px #fff;" id="unselect" class=" p-3  border rounded-md w-[120px] text-center text-xs hover:bg-gray-200 leading-4 ">Bỏ
                        chọn tất cả
                    </label>

                    <button style="text-shadow: 0.6px 0.6px 0 #fff; color: #61677c; box-shadow:
1.5px 1.5px 2.5px #babecc, -2px -2px 5px #fff;" type="submit" name="btn_delete" class=" p-3  border rounded-md w-[120px] text-center whitespace-nowrap  text-xs hover:bg-gray-200 leading-4 ">
                        Xóa mục đã chọn
                    </button>
...
1.5px 1.5px 2.5px #babecc, -2px -2px 5px #fff;" class="p-2  border rounded-md w-[120px] text-center   text-xs hover:bg-gray-200 leading-4 ">
                        <a href="<?= $STAFF_URL ?>/categories/index.php">
                            Thêm mới
                        </a>
                    </button>
                </div>
