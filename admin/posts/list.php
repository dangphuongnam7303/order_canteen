                ...
                <div class="list__accounts-table w-full mt-4">
                    <table class="w-full text-center rounded-md shadow-md my-3">
                        <thead class="boder bg-gray-200 px-2 rounded-t-md">
                            <tr>
                                <th class=" text-xs  py-2 font-medium whitespace-nowrap">
                                    User Name
                                </th>
                                <th class=" text-xs  py-2 w-20 font-medium whitespace-nowrap">
                                    Họ và tên
                                </th>
                                ...
                                <th class=" text-xs  p-2 font-medium whitespace-nowrap">
                                    Mới nhất
                                </th>
                        ...
                        <tbody>
                            <?php foreach ($items as $item) {
                                extract($item);
                            ?>
                            <tr class="bpost-t-2 bpost-dashed p-2">
                                ...
                                <td class="px-2 mt-2 whitespace-nowrap flex gap-3 items-center justify-center">
                                    <a href="<?= $ADMIN_URL ?>/posts/index.php?user_id=<?= $user_id ?>"
