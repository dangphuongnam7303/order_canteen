...
#bebebe, -35px -35px 70px #ffffff; " class="w-full  p-5 mt-5 bg-gray-100">
        <section class="list__accounts w-full">
            ...
            <form action="index.php?post_id=<?= $post_id ?>" method="post">
                <h3 class="text-indigo-500 text-sm font-medium my-5">Mã bài đăng : <?= $items[0]['post_id'] ?></h3>
                        ...
                        <tbody>
                            ...
                            <tr class="border-t-2 border-dashed">
                                <td class="p-2 whitespace-nowrap">
                                    <input type="checkbox" name="comment_id[]" value="<?= $comment_id ?>"
                                        class="checkbox" />
                                </td>
                                <td class="p-2">
                                ...
                                <td class="p-2 text-xs text-gray-900">
                                    <?php if (strpos($image, ".") !== false) { ?>
                                    <img class="rounded-lg block mx-auto object-cover object-center"
                                        src="<?= $CONTENT_URL ?>/images/comments/<?= $image ?>" width="60" height="60"
                                        alt="Ảnh bình luận">
                                    <?php } else {
                                            echo "Không có ảnh";
                                        }
                                ...
                                <td class="px-2">
                                    <a href="index.php?btn_delete&comment_id=<?= $comment_id ?>&post_id=<?= $post_id ?>"
                                        class="text-indigo-600 hover:text-indigo-900 flex justify-center"><svg
...
1.5px 1.5px 2.5px #babecc, -2px -2px 5px #fff;" id="select"
                        class=" whitespace-nowrap  p-3  border  w-[120px] text-center rounded-md text-xs hover:bg-gray-200 leading-4 ">
                        Chọn tất cả
                    </label>
                    <label for="checkAll" style="text-shadow: 0.6px 0.6px 0 #fff; color: #61677c; box-shadow:
1.5px 1.5px 2.5px #babecc, -2px -2px 5px #fff;" id="unselect"
                        class="whitespace-nowrap  p-3  border rounded-md w-[120px] text-center text-xs hover:bg-gray-200 leading-4 ">
                        Bỏ chọn tất cả
                    </label>
...
1.5px 1.5px 2.5px #babecc, -2px -2px 5px #fff;" type="submit" name="btn_delete"
                        class=" p-3  border whitespace-nowrap  rounded-md w-[120px] text-center   text-xs hover:bg-gray-200 leading-4 ">
                        Xóa mục đã chọn
                    </button>
                    <button style="text-shadow: 0.6px 0.6px 0 #fff; color: #61677c; box-shadow:
1.5px 1.5px 2.5px #babecc, -2px -2px 5px #fff;" type="submit" name="btn_list"
                        class=" p-3  border rounded-md  text-center whitespace-nowrap   text-xs hover:bg-gray-200 leading-4 ">
                        Danh sách bình luận
                    </button>
